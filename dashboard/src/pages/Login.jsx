      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '22px' }}>
            <div style={{ fontSize: '1.15rem', fontWeight: 600, color: 'var(--tx)', marginBottom: '4px' }}>Sign in</div>
            <div style={{ fontSize: '.82rem', color: 'var(--tx3)' }}>Access your MU AI platform</div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            {error && (
              <div style={{ background: 'var(--redbg)', border: '1px solid var(--redbd)', color: 'var(--red)', padding: '10px 14px', borderRadius: '8px', fontSize: '.83rem' }}>
                {error}
              </div>
            )}
