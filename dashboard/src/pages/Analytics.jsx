  ...
  return (
    <div className="page">
      <div className="page-header">
        <div><div className="page-title">Analytics</div><div className="page-sub">Understand performance, conversion rates, and where opportunities are being lost.</div></div>
      </div>
